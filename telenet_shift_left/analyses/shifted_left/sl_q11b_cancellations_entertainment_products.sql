...
select
    ...
    sum(abs(nap.reg_org_cncl_net_add_prd_no)) as total_cancellations
...
where 1=1
    and d.month between '2025-09' and '2025-11' --specify the months here
    ...
    --     )
    and pp.product_type_desc = 'Content Product'
    and pp.cleaned_entertainment_product not ilike '%combo%'
group by all
order by 1, 2
